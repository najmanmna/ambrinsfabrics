...
//           >
//             Whether you have a question about our fabrics, need help with an
//             order, or just want to say hello, we are here for you.
//           </motion.p>
//         </Container>
//       </div>
...
//                   <a
//                     href="https://wa.me/94777212229"
//                     target="_blank"
//                     rel="noopener noreferrer"
//                     className="hover:text-[#25D366] transition-colors font-medium flex items-center gap-1"
...
//                   className="text-gray-600 mt-1 hover:text-[#A67B5B] block truncate"
//                 >
...
//                     <br />7 3/2 B Galle Road, Opposite Savoy Cinema, Colombo 06.
//                   </p>
//                 </div>
//               </div>
...
//                   className="bg-white p-3 rounded-full shadow-sm text-gray-600 hover:text-[#E1306C] hover:scale-110 transition-all"
//                 >
//                   <Instagram className="w-5 h-5" />
//                 </a>
//                 <a
//                   href="https://www.facebook.com/eldaclothinglk"
//                   className="bg-white p-3 rounded-full shadow-sm text-gray-600 hover:text-[#1877F2] hover:scale-110 transition-all"
//                 >
//                   <Facebook className="w-5 h-5" />
//                 </a>
//                 <a
//                   href="https://www.tiktok.com/@eldalk?is_from_webapp=1&sender_device=pc"
//                   className="bg-white p-3 rounded-full shadow-sm text-gray-600 hover:text-black hover:scale-110 transition-all"
//                 >
...
//           >
//             <div className="mb-8">
//               <h2 className="text-2xl font-bold font-playfair text-[#2C3E50]">
//                 Send a Message
//               </h2>
//               <p className="text-gray-500 mt-2">
//                 We'd love to discuss your fabric needs.
//               </p>
//             </div>
...
//                 Thank you for contacting ELDA. We have sent a confirmation to
//                 your email.
//               </p>
